...
#load weight matrix
wMa_pprel_file = open ("/Users/yanyan/neuralNetwork/wMa.pprel.txt",'r')
...
wMa_tf_file = open ("/Users/yanyan/neuralNetwork/wMa.tf.txt",'r')
